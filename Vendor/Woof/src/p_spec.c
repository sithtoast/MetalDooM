...
static animdef_t native_animdefs[] =
{
...
void P_InitPicAnims (void)
{
  ...
  int native_lump = W_CheckNumForName("ANIMATED");
  animdefs = native_lump < 0 ? native_animdefs : W_CacheLumpNum(native_lump, PU_STATIC);
  ...
  if (native_lump >= 0) Z_ChangeTag (animdefs,PU_CACHE); //jff 3/23/98 allow table to be freed
}
