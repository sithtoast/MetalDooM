...
Save/Load preserves object and respawn blend tables. See EXTENDED_TRANSLUCENCY.md
and EXTENDED_INTERPOLATION.md.

Build 155 added sector-local sky transfers, live sky offsets and independent
floor/ceiling rotation. See EXTENDED_SKIES_ROTATION.md.

Build 152 adds fake floors, deep-water/above-ceiling views, transferred floor/ceiling
lighting and actor clipping. See EXTENDED_CONTROL_SECTORS.md.

Build 151 adds translucent middle walls with shared wall/actor ordering, plus
damage/pickup/berserk/radiation palettes, invulnerability and light amplification.
See EXTENDED_TRANSLUCENCY.md and EXTENDED_PALETTES.md.

Build 148 smooths camera movement, turning and existing weapon bob during Run.
Pause and discontinuities snap to engine state; manual steps remain exact.
See EXTENDED_INTERPOLATION.md for timing and remaining world-rendering limits.

Build 146 renders independent scrolling floors and ceilings with saved phase
and updates limited to affected flat meshes. See EXTENDED_SCROLLING.md.
...
XFINALE1's seven-member cast with patched sound identities and nonlooping music.
Presentation has independent pause/resume; restarting clears the overlay and
returns to a fresh paused world. See EXTENDED_CAMPAIGN.md.

Build 143 adds death/restart, inventory-preserving Continue, a native completion
