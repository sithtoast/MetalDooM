...
- Pushing a tag exactly matching `Info.plist`, such as `v0.3.0`, imports your
...
```bash
cd /Users/wmh/Dev/MetalDooM
git tag -a v0.3.0 -m "MetalDooM 0.3.0 preview"
...
The app version (for example 0.3.0) is separate from both counters.
