    ...
    static func main() throws {
        ...
        for number in 1...16 {
            ...
            if number == 13 {
                ...
                cases += [mutate(4,2),mutate(28,UInt32.max),mutate(28,1_000_001),mutate(12,99)]
                let bytes=Bytes(data:data),counts=try (0..<7).map{try bytes.i32(28+$0*4)},strides=[8,20,36,28,16,12,24]
