...
- Pushing a tag exactly matching `Info.plist`, such as `v0.2.1`, imports your
...
```bash
cd /Users/wmh/Dev/MetalDooM
git tag -a v0.2.1 -m "MetalDooM 0.2.1 preview"
...
The app version (for example 0.2.1) is separate from both counters.
