...
assert exports == {'_ME_Init','_ME_Tick','_ME_CopySnapshot','_ME_CopyThings','_ME_CopyError','_ME_CopySession','_ME_CopyGeometry','_ME_CopyView','_ME_CopyPresentation'}, exports
