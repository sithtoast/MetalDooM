...
assert exports == {'_ME_Init','_ME_Tick','_ME_CopySnapshot','_ME_CopyThings','_ME_CopyError','_ME_CopySession','_ME_CopyGeometry','_ME_CopyView','_ME_CopyPresentation','_ME_CopyMaterials','_ME_CopyBlendTables','_ME_EnableAudio','_ME_CopyAudio','_ME_CopyUI','_ME_Advance','_ME_CopyCampaign','_ME_CopySave','_ME_RestoreSave'}, exports
