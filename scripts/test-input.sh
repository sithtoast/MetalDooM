...
xcrun swiftc -swift-version 5 -O -target arm64-apple-macosx14.0 \
  ...
  "$PROJECT_DIR/Sources/SaveStore.swift" "$PROJECT_DIR/Sources/IntermissionSequence.swift" "$PROJECT_DIR/Sources/IntermissionRenderer.swift" "$PROJECT_DIR/Sources/MUS.swift" "$PROJECT_DIR/Sources/MusicPlayer.swift" "$PROJECT_DIR/Sources/OPLPlayer.swift" "$PROJECT_DIR/Sources/SoundPlayer.swift" "$PROJECT_DIR/Sources/Renderer.swift" "$PROJECT_DIR/Sources/SpriteRenderer.swift" \
